...
GAS utilise exclusivement la feuille `COMMANDES_APP` pour les demandes reçues pendant une indisponibilité D1. Aucun schéma d'inventaire, de catalogue ou de MU n'est modifié.
